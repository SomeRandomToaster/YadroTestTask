...
void TAMP_STAMP_Handler(void) __attribute__((alias("Default_Handler")));
void RTC_WKUP_Handler(void) __attribute__((alias("Default_Handler")));
...
void CAN1_TX_Handler(void) __attribute__((alias("Default_Handler")));
void CAN1_RX0_Handler(void) __attribute__((alias("Default_Handler")));
void CAN1_RX1_Handler(void) __attribute__((alias("Default_Handler")));
void CAN1_SCE_Handler(void) __attribute__((alias("Default_Handler")));
void EXTI9_5__Handler(void) __attribute__((alias("Default_Handler")));
...
void USART3_Handler(void) __attribute__((alias("Default_Handler")));
...
void TIM8_BRK_TIM12_Handler(void) __attribute__((alias("Default_Handler")));
void TIM8_UP_TIM13_Handler(void) __attribute__((alias("Default_Handler")));
void TIM8_TRG_COM_TIM14_Handler(void) __attribute__((alias("Default_Handler")));
void TIM8_CC_Handler(void) __attribute__((alias("Default_Handler")));
void DMA1_Stream7_Handler(void) __attribute__((alias("Default_Handler")));
void FSMC_Handler(void) __attribute__((alias("Default_Handler")));
...
void UART4_Handler(void) __attribute__((alias("Default_Handler")));
void UART5_Handler(void) __attribute__((alias("Default_Handler")));
void TIM6_DAC_Handler(void) __attribute__((alias("Default_Handler")));
void TIM7_Handler(void) __attribute__((alias("Default_Handler")));
...
void ETH_Handler(void) __attribute__((alias("Default_Handler")));
void ETH_WKUP_Handler(void) __attribute__((alias("Default_Handler")));
void CAN2_TX_Handler(void) __attribute__((alias("Default_Handler")));
void CAN2_RX0_Handler(void) __attribute__((alias("Default_Handler")));
void CAN2_RX1_Handler(void) __attribute__((alias("Default_Handler")));
void CAN2_SCE_Handler(void) __attribute__((alias("Default_Handler")));
...
void OTG_HS_EP1_OUT_Handler(void) __attribute__((alias("Default_Handler")));
void OTG_HS_EP1_IN_Handler(void) __attribute__((alias("Default_Handler")));
void OTG_HS_WKUP_Handler(void) __attribute__((alias("Default_Handler")));
void OTG_HS_Handler(void) __attribute__((alias("Default_Handler")));
void DCMI_Handler(void) __attribute__((alias("Default_Handler")));
void CRYP_Handler(void) __attribute__((alias("Default_Handler")));
void HASH_RNG_Handler(void) __attribute__((alias("Default_Handler")));
